    ...
    <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2 items-end pointer-events-none">
      {instaHandle && (
        <a
          ...
          className="pointer-events-auto h-12 w-12 rounded-full shadow-lg flex items-center justify-center text-white transition-transform hover:scale-110 active:scale-95"
          style={{
            background:
      ...
      {whatsDigits && (
        <a
          ...
          className="pointer-events-auto h-14 w-14 rounded-full shadow-lg flex items-center justify-center text-white transition-transform hover:scale-110 active:scale-95"
